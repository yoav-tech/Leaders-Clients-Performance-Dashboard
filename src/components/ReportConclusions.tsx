      ...
      {canEdit ? (
        <>
          <textarea
            ...
            className="w-full rounded-lg border border-[var(--card-border)] bg-[var(--background)] p-3 text-sm text-[var(--foreground)] outline-none focus:border-[var(--panel-border)]"
          />
